      ...
      <div className='max-w-[1240px] mx-auto py-12'>
        ...
        <div className='grid md:grid-cols-2'>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div>
              <p className='text-6xl font-bold py-4 flex'>N30,000<span className='text-xl text-slate-500 flex flex-col justify-end'>/mo</span></p>
            </div>
          ...
          <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
            ...
            <div>
              <p className='text-6xl font-bold py-4 flex'>N100,000<span className='text-xl text-slate-500 flex flex-col justify-end'>/mo</span></p>
            </div>
            <p className='text-2xl py-8 text-slate-500'>Lorem ipsum dolor, sit amet consectetur adipisicing.</p>
            <div className='text-2xl'>
                <p className='flex py-4'><CheckIcon className='w-8 mr-5 text-green-600'  />Lorem, ipsum dolor.</p>
